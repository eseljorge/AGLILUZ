...
if df.empty:
    st.warning("⚠️ No se encontró el archivo de historial maestro (`historial_licitaciones.xlsx`). Ejecuta primero el script principal en GitHub Actions para poblar los datos.")
else:
    # --- BARRA LATERAL DE FILTROS ---
    st.sidebar.header("🔍 Filtros de Consulta")
    
    # Filtro por Nivel de Compatibilidad
    ...
    # Filtro por Categoría de Proyecto
    ...
    # Buscador por texto libre (ID, Nombre, Comprador)
    ...
    with tab1:
        ...
        # Selector de detalle por proceso específico
